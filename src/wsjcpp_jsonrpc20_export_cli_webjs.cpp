...
void WsjcppJsonRpc20ExportCliWebJs::setAuthorName(const std::string &sAuthorName) {
    m_sAuthorName = sAuthorName;
}

// ---------------------------------------------------------------------

void WsjcppJsonRpc20ExportCliWebJs::setAuthorEmail(const std::string &sAuthorEmail) {
...
void WsjcppJsonRpc20ExportCliWebJs::setKeywords(const std::vector<std::string> &vKeywords) {
...
void WsjcppJsonRpc20ExportCliWebJs::setLibraryName(const std::string &sLibraryName) {
...
void WsjcppJsonRpc20ExportCliWebJs::exportPackageJson() {
    ...
    packageJson << 
        ...
        "    \"url\": \"" + m_sIssuesURL + "\"\n"
        "  },\n"
        "  \"author\": \"" + m_sAuthorName + " <" + m_sAuthorEmail + ">\",\n"
...
void WsjcppJsonRpc20ExportCliWebJs::exportLibCliWebServiceTSFile() {
    ...
    libwjscppcli_web_service_ts_file <<
        ...
        "  private _tokenName: string = '" + m_sLibraryName + "token';\r\n"
        "  userdata: any = {};\r\n"
